...
Offhand extends Module {
    ...
    public Setting<Float> crystalHealth = register(new Setting<Float>("CrystalHP", Float.valueOf(14.5f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Float> crystalHoleHealth = register(new Setting<Float>("CrystalHoleHP", Float.valueOf(14.5f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    ...
    private boolean shouldTotem() {
        boolean hp = (mc.player.getHealth() + mc.player.getAbsorptionAmount() <= this.crystalHealth.getValue());
