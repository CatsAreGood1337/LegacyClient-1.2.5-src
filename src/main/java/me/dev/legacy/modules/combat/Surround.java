...
public class Surround extends Module {
    ...
    private final Setting<Integer> blocksPerTick = register(new Setting<Integer>("BPT", 20, 1, 20));
    ...
    private final Setting<Boolean> floor = this.register( new Setting<Boolean>("Floor", true));
