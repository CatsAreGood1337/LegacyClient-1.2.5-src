...
public class Replenish extends Module {
    ...
    private final Setting<Integer> gapStack = register(new Setting<Integer>("GapStack", 32, 1, 64));
    private final Setting<Integer> xpStackAt = register(new Setting<Integer>("XPStack", 32, 1, 64));
