...
public class PearlNotify extends Module {
    ...
    public void onUpdate() {
        ...
        if (closestPlayer != null && flag) {
            ...
            Command.sendMessage(Legacy.friendManager.isFriend(closestPlayer.getName()) ? (ChatFormatting.WHITE + closestPlayer.getName() + ChatFormatting.AQUA + " has just thrown a pearl heading " + faceing + "!") : (ChatFormatting.WHITE + closestPlayer.getName() + ChatFormatting.AQUA + " has just thrown a pearl heading " + faceing + "!"));
            flag = false;
        }
    }
}