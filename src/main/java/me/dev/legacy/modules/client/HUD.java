...
import me.dev.legacy.api.util.Render.TextUtil;
...
public class HUD extends Module {
    ...
    private final Setting<Boolean> line = register(new Setting("RainbowBar", Boolean.valueOf(false), "Cs moode."));
    public Setting<Integer> lineoffset = register(new Setting("Offset", Integer.valueOf(1000), Integer.valueOf(0), Integer.valueOf(1000), v -> (line.getValue())));
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        if (renderingUp.getValue().booleanValue()) {
            ...
            if(line.getValue()){
                int padding = 5;
                RenderUtil.drawHLineG(0 - padding, 5 - padding,1000 - padding, RainbowUtil.getColour().hashCode(), RainbowUtil.getFurtherColour(lineoffset.getValue()).hashCode());
            }
