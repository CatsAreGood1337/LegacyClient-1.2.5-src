...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
       ...
       RenderUtil.drawSidewaysGradientRect(this.x, this.y - 5, this.x + this.width + 20, this.y + this.height - 6, ClickGui.getInstance().rainbow.getValue() != false ? ColorUtil.rainbow(ClickGui.getInstance().rainbowHue.getValue()).getRGB() : color, startcolor);
        ...
        int color2 = ColorUtil.toARGB(ClickGui.getInstance().fontcolorr.getValue(), ClickGui.getInstance().fontcolorg.getValue(), ClickGui.getInstance().fontcolorb.getValue(), 255);
        ...
        Legacy.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f + 30, (float) this.y - 4.0f - (float) LegacyGui.getClickGui().getTextOffset() - 2, color2);
        if (this.open) {
